...
const DetailsStudio = ({ route }) => {
  ...
  const studio = { id: 1, name: "Teagher Studio", image: require('./../components/images/teagherStudio.jpg'), description: "A group of weird people making weird games. That's...", join_date: "2024-04-10"};
  ...
  return (
    <SafeAreaView style={styles.backgroundStyle}>
      <ScrollView style={styles.addMargin} nestedScrollEnabled>
        ...
        />
        <TextInput style={styles.commentText} multiline></TextInput>
        <TouchableOpacity>
          <Image style={styles.commentButton} source={require("../components/images/send.png")}/>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
