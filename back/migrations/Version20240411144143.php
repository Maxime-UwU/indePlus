 ...
 */
final class Version20240411144143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game DROP tags');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD tags VARCHAR(255) NOT NULL');
